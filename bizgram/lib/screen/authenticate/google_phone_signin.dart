...
class GooglePhoneSignIn extends StatefulWidget {
  final phoneNumber;
  final displayName;
  final email;
  GooglePhoneSignIn(
  ...
  @override
  _GooglePhoneSignInState createState() => _GooglePhoneSignInState();
}

class _GooglePhoneSignInState extends State<GooglePhoneSignIn> {
